...
namespace Digital.Diary.Services.Emergency_Services
{
    public class CourierService : Service<Courier>, ICourierService
    {
        ...
        public CourierService(ICourierRepository repo) : base(repo)
        {
            _repo = repo;
        }

        public override Result Create(Courier entity)
        {
            var result = new Result();
            //code Designation
            var checkEntity = _repo.GetAll(c => c.CourierName == entity.CourierName);
        ...
        public override Result Update(Courier entity)
        {
            var result = new Result();
        ...
        public override Result Remove(Courier entity)
        {
            var result = new Result();
