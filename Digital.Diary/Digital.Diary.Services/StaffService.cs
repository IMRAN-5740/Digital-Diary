...
namespace Digital.Diary.Services
{
    public class StaffService : Service<Staff>, IStaffService
    {
        ...
        public StaffService(IStaffRepository repo) : base(repo)
        {
            _repo = repo;
        }

        public override Result Create(Staff entity)
        {
        ...
        public override Result Update(Staff entity)
        {
            var result = new Result();
        ...
        public override Result Remove(Staff entity)
        {
            var result = new Result();
