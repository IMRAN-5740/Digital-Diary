...
namespace Digital.Diary.Services
{
    public class TeacherService : Service<Teacher>, ITeacherService
    {
        ...
        public TeacherService(ITeacherRepository repo) : base(repo)
        {
            _repo = repo;
        }

        public override Result Create(Teacher entity)
        {
        ...
        public override Result Update(Teacher entity)
        {
            var result = new Result();
        ...
        public override Result Remove(Teacher entity)
        {
            var result = new Result();
