...
{
    public class FireStationRepository : Repository<FireStation>, IFireStationRepository
    {
        public FireStationRepository(ApplicationDbContext dbContext) : base(dbContext)
        {
