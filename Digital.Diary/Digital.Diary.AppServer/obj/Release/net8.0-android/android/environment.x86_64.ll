...
@dso_cache = dso_local local_unnamed_addr global [480 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 7310178871665738069, ; hash 0x6572f8f3ea33c155, from name: libaot-Digital.Diary.AppServer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digital.Diary.AppServer.dll.so
		ptr null; void* handle (0x0)
	}, ; 167
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 8351966588627786229, ; hash 0x73e8255c9b1719f5, from name: aot-Digital.Diary.AppServer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digital.Diary.AppServer.dll.so
		ptr null; void* handle (0x0)
	}, ; 200
	...
	%struct.DSOCacheEntry {
		i64 9081648217630382278, ; hash 0x7e087eeff2eb18c6, from name: Digital.Diary.AppServer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digital.Diary.AppServer.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 10287456619229113398, ; hash 0x8ec4634a37646c36, from name: aot-Digital.Diary.AppServer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digital.Diary.AppServer.dll.so
		ptr null; void* handle (0x0)
	}, ; 259
	...
	%struct.DSOCacheEntry {
		i64 16510401725258390973, ; hash 0xe520bae4ad05ddbd, from name: libaot-Digital.Diary.AppServer
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digital.Diary.AppServer.dll.so
		ptr null; void* handle (0x0)
	}, ; 429
	...
	%struct.DSOCacheEntry {
		i64 17701389909926280688, ; hash 0xf5a7f8564bd6fdf0, from name: Digital.Diary.AppServer.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Digital.Diary.AppServer.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7e8ce670-d33f-4bf3-bd5c-f01fd43acb98\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [40 x i8] c"com.companyname.digital.diary.appserver\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [38 x i8] c"libaot-Digital.Diary.AppServer.dll.so\00", align 16
